...
"5. Click on the Import option from the Actions menu in the application and choose the file to upload"
   ',
    ...
    'LBL_NEW_EM_SURVEY' => 'Create Survey Email',
    'LBL_NEW_EM_TRANSACTIONAL' => 'Create Transactional Email',
    'LBL_NEW_EM_MARKETING' => 'Create Marketing Email',
    'LBL_NEW_SURVEY' => 'Create Survey',
    'LBL_WEB_TO_LEAD' => 'Create Web to Lead Form',
    'LBL_TYPE' => 'Type',
