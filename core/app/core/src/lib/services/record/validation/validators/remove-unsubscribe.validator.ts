...
export const removeUnsubscribeValidator = (viewField: ViewFieldDefinition, record: Record): StandardValidatorFn => (
...
export class RemoveUnsubscribeValidator implements ValidatorInterface {
