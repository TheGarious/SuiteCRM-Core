...
class CampaignsTargetListsSaveApiMapper implements ApiRecordMapperInterface
{
    ...
    {
        return 'campaigns-target-lists-save';
    }
    ...
    public function toInternal(Record $record, FieldDefinition $fieldDefinitions): void
    {
        ...
        $fields = ['propects_lists', 'suppression_lists'];
        ...
        foreach ($fields as $field) {
            ...
            $listValues = $attributes[$field] ?? [];

            $mergedLists = $this->joinList($listValues, $mergedLists);
        }

        $attributes['propects_lists'] = $mergedLists;
